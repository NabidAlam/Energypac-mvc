...
namespace AuditReport.Controllers
{
    ...
    public class CompanyInformationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Phone,ContactPerson,Address")] CompanyInformation companyInformation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Phone,ContactPerson,Address")] CompanyInformation companyInformation)
        {
            if (ModelState.IsValid)
            {
